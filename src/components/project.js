      ...
      <div className="pr-0 pl-0">
        ...
        <div className="row justify-content-center pl-3 pr-3">
          <div className="col-xs-12 col-md-6">
            ...
            <div className="row justify-content-center pb-5">
              <a
                ...
                rel="noreferrer"
              >
                <button className="btn-site">Accéder au site</button>
              </a>
              ...
              {this.props.data.github && (
                <a
                  ...
                  rel="noreferrer"
                >
                  <button className="btn-site">Code source</button>
                </a>
              )}
            </div>
          ...
          <div className="col-xs-12 col-md-5 pl-3">
            <h4 className="textyellow textspaced">Brief de mission:</h4>
            ...
            <h4 className="textyellow textspaced pt-3">Creation:</h4>
