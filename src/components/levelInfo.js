        ...
        return(
            <div className="gameinfo pt-2 pb-2">
                <div className="text-center">
                    {/* <h4 className="textyellow textspaced">Niveau actuel :</h4>
                    <h3 className="textblue textspaced">{this.props.page}</h3>
                    <hr className="navbreak" /> */}
                    <h5 className="return text-white textspaced blink_me_slow mt-2" id="MENU" onClick={this.handleClick} >Retour au menu</h5>
                </div>
            </div>
        )
    }
